...
describe BusinessReports::Metrics::TotalReportsByCategory do
  let(:date_range) do
  ...
  describe '#fetch_data' do
    ...
    let!(:reports1) do
      create(:reports_item, category: category1, created_at: date_range.to_a.sample)
    end
    ...
    let!(:invalid_reports2) do
      create_list(:reports_item, 3, category: category2, created_at: (date_range.first - 1.day))
    end
