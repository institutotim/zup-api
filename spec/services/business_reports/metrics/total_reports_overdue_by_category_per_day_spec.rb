...
describe BusinessReports::Metrics::TotalReportsOverdueByCategoryPerDay do
  let(:date_range) do
  ...
  describe '#fetch_data' do
    ...
    let!(:invalid_reports1) do
      create_list(:reports_item, 2, category: category1, created_at: date_range.to_a.sample)
    end
    ...
    before do
      reports1.each(&:overdue!)
      reports2.each(&:overdue!)
    end
